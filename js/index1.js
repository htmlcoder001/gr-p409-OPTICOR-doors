...
function tick() {
  time -= 1;
  var e = Math.floor(time / 60), o = time - 60 * e;
...
let doors = document.querySelectorAll(".door"), doorSales = document.querySelectorAll(".door__sales"),
  doorWrapper = document.querySelector(".door__wrapper"),
  spinResultWrapper = document.querySelector(".spin-result-wrapper"),
  spinResultBtn = document.querySelector(".pop-up-button"), orderBlock = document.querySelector(".order_block"),
  orderBlock2 = document.querySelector(".lead-form-box"), closedPopup = document.querySelector(".close-popup"),
  door1 = document.getElementById("door__1"), door2 = document.getElementById("door__2"),
  door3 = document.getElementById("door__3"), doorSale1 = document.getElementById("door__sales1"),
  doorSale2 = document.getElementById("door__sales2"), doorSale3 = document.getElementById("door__sales3");
...
function openDoor(e) {
  e.currentTarget.classList.add("open"), setTimeout((function () {
  ...
  }), 3500), spinResultBtn.onclick = function () {
    ...
    start_timer(), orderBlock.style.display = "block", orderBlock2.style.display = "block", doorWrapper.style.display = "none"
  }, door1.classList.contains("open") ? (doorSale1.innerHTML = "50%", doorSale1.style.left = "12px", doorSale2.innerHTML = "25%", doorSale2.style.left = "30px", doorSale3.innerHTML = "10%", doorSale3.style.left = "32px") : door2.classList.contains("open") ? (doorSale2.innerHTML = "50%", doorSale2.style.left = "12px", doorSale1.innerHTML = "25%", doorSale1.style.left = "32px", doorSale3.innerHTML = "10%", doorSale3.style.left = "30px") : door3.classList.contains("open") && (doorSale1.innerHTML = "25%", doorSale1.style.left = "30px", doorSale3.innerHTML = "50%", doorSale3.style.left = "12px", doorSale2.innerHTML = "10%", doorSale2.style.left = "32px");
...
const months = ["януари", "февруари", "март", "април", "май", "юни", "юли", "август", "септември", "октомври", "ноември", "декември"],
  ...
  daysMin = ["", "", "", "", "", "", ""], seasons = ["зима", "пролет", "лято", "есен"];
...
function postDate(e, o, t, r, n) {
  ...
  function l(e, o) {
    let t;
    t = "date-" === o ? -e : e;
    const r = new Date(Date.now() + 864e5 * t), n = r.getDate(), l = r.getMonth() + 1, d = r.getFullYear(), a = i(n),
      c = a + "." + i(l) + "." + d, u = o + e, p = document.querySelectorAll("." + u);
...
function validateNum(e) {
  var o = e || window.event, t = o.keyCode || o.which;
...
document.body.classList.contains("ev-date") && document.addEventListener("DOMContentLoaded", (function () {
  ...
  event.preventDefault(), $(this).attr("href", "#form");
  var e = $(this).attr("href"), o = $(e).offset().top;
  $("body,html").animate({scrollTop: o - 70}, 0)
}));